export function SparklesIcon({ size = 13 }) {
  return (
...
export function ChatWindowIcon() {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" aria-hidden="true">
      <path
        ...
        d="M5 4.75h14A2.25 2.25 0 0 1 21.25 7v9A2.25 2.25 0 0 1 19 18.25H9.15L4.75 21.5V7A2.25 2.25 0 0 1 7 4.75H5z"
      />
      <path stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" d="M8.5 9.25h7M8.5 12.75h4.5" />
    </svg>
  );
}
...
export function ArrowUpIcon() {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden="true">
      <path fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" d="M12 19V5M5 12l7-7 7 7" />
    </svg>
  );
}
...
export function FolderIcon({ size = 16 }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" aria-hidden="true">
      <path
        d="M3.75 6.75A1.5 1.5 0 0 1 5.25 5.25h3.4c.5 0 .97.25 1.25.66l.8 1.19h8.05a1.5 1.5 0 0 1 1.5 1.5v9.15a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5V6.75z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinejoin="round"
      />
...
export function DownloadIcon({ size = 18 }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" aria-hidden="true">
      <path
        d="M12 4v11M7 11l5 5 5-5M5 19.5h14"
        stroke="currentColor"
        strokeWidth="1.85"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" aria-hidden="true">
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M19 4.5V9h-4.5" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M5 19.5V15h4.5" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
