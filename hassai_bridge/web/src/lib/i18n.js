...
const I18N = {
  en: {
    ...
    haFilesMenuHint: "From /share and /media — never closes the add-on",
    browserUpload: "Send from the phone browser",
    browserUploadHint: "Opens a page outside the app; the file lands here on its own",
    browserUploadWaiting: "Waiting for the file from the browser…",
    browserUploadArrived: "File received",
    browserUploadFailed: "Could not open the upload link",
    haFilesUp: "Back",
  ...
  ro: {
    ...
    haFilesMenuHint: "Din /share și /media — nu iese din add-on",
    browserUpload: "Trimite din browserul telefonului",
    browserUploadHint: "Deschide o pagină în afara aplicației; fișierul ajunge singur aici",
    browserUploadWaiting: "Aștept fișierul din browser…",
    browserUploadArrived: "Fișier primit",
    browserUploadFailed: "Nu am putut deschide linkul de încărcare",
    haFilesUp: "Înapoi",
