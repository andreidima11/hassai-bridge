    ...
    <div className="flex h-full w-full overflow-hidden">
      ...
      <div className="relative flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-background">
        <header className="flex shrink-0 items-center justify-between px-6 py-2 pt-[max(0.5rem,env(safe-area-inset-top))] md:px-2">
          <button
            className="-ml-1 grid size-9 place-items-center rounded-full text-muted-foreground hover:bg-white/10 hover:text-foreground"
            type="button"
          ...
          <a
            className="-mr-1 grid size-9 place-items-center rounded-full text-muted-foreground hover:bg-white/10 hover:text-foreground"
            href={settingsHref}
