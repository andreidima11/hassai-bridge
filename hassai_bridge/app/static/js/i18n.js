...
const TRANSLATIONS = {
  en: {
    ...
    'settings.imageGenProviderDesc': 'Optional. Grok provider for the generate_image tool when the primary model cannot create images (e.g. DeepSeek primary + Grok for generation).',
  ...
  ro: {
    ...
    'settings.imageGenProviderDesc': 'Opțional. Provider Grok pentru tool-ul generate_image când modelul principal nu poate crea imagini (ex. DeepSeek + Grok pentru generare).',
    'settings.imageGenShort': 'Img Gen',
