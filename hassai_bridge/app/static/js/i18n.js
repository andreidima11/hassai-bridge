...
const TRANSLATIONS = {
  en: {
    ...
    // Users
    'users.title': 'Users',
    'users.desc': 'Manage users and API keys. Each user gets personalized AI memory.',
  ...
  ro: {
    ...
    'users.desc': 'Gestionează utilizatorii și cheile API. Fiecare utilizator primește memorie AI personalizată.',
