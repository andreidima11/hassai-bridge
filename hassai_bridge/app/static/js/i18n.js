...
const TRANSLATIONS = {
  en: {
    ...
    'settings.visionMode': 'Image handling',
    'settings.visionModeDesc': 'When images go to a separate vision or auxiliary model. Direct: that model answers. Relay: it only describes the image; your primary model formulates the reply (better for small vision models).',
    'settings.visionModeDirect': 'Direct — Vision model answers',
    'settings.visionModeRelay': 'Relay — Vision describes, primary answers',
    ...
    'stats.kvCache': 'KV Cache (DeepSeek)',
  ...
  ro: {
    ...
    'settings.visionMode': 'Procesare imagini',
    'settings.visionModeDesc': 'Când pozele merg la un model vision sau auxiliar separat. Direct: acel model răspunde. Relay: doar descrie imaginea; modelul principal formulează răspunsul (recomandat pentru modele vision mici).',
    'settings.visionModeDirect': 'Direct — Vision răspunde',
    'settings.visionModeRelay': 'Relay — Vision descrie, principal răspunde',
